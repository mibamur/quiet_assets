...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.md", "lib/quiet_assets.rb", "quiet_assets.gemspec", "test/test_quiet_assets.rb"]
  s.homepage = "http://github.com/evrone/quiet_assets"
  s.licenses = ["MIT", "GPL"]
  s.rubygems_version = "2.5.1"
  s.summary = "Turns off Rails asset pipeline log."
  s.test_files = ["test/test_quiet_assets.rb"]

  if s.respond_to? :specification_version then
    s.specification_version = 4

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<railties>, ["< 5.1", ">= 3.1"])
      s.add_development_dependency(%q<rake>, [">= 0"])
      s.add_development_dependency(%q<tzinfo>, [">= 0"])
    else
      s.add_dependency(%q<railties>, ["< 5.1", ">= 3.1"])
